          ...
          <CardHeader className="pb-3 relative">
            ...
            <div className="flex items-start justify-between ml-10">
              ...
              <Button
                ...
                title={!canEdit && !isCreator ? "You can view but not modify project settings" : "Project settings"}
              >
          ...
          <CardFooter className="flex flex-col items-stretch pt-0">
            <div className="flex items-center justify-between py-2">
              <div className="text-sm">
                <span className="font-medium text-purple-500">{completedTasksCount}</span> of{" "}
                <span className="font-medium">{project.tasks.length}</span> tasks completed
              </div>
              <Button
                variant="ghost"
                size="sm"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the project &quot;{project.title}&quot; and all its tasks. This action cannot
              be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

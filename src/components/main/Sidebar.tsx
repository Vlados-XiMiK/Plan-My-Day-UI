    ...
    <aside
      className={`fixed inset-y-0 left-0 z-30 flex h-full flex-col transition-all duration-300 ease-out
        ...
        border-r ${
          isDarkTheme
            ? "border-purple-900"
            : "border-gray-300 sm:border-gray-200"
        }`}
    >
      <div
            ...
            ${
              pathname === "/dashboard/stats"
                ? `${
                    isDarkTheme
                      ? "bg-purple-700"
                      : "bg-amber-200 sm:bg-amber-100"
                  } text-${isDarkTheme ? "white" : "amber-900 sm:amber-800"}`
                : ""
            }`}
        >
          <BarChart3
            className={`${isCollapsed ? "h-7 w-7" : "mr-3 h-7 w-7"}`}
          />
            ...
            ${
              pathname === "/dashboard/tasks"
                ? `${
                    isDarkTheme
                      ? "bg-purple-700"
                      : "bg-emerald-200 sm:bg-emerald-100"
                  } text-${
            ...
            ${
              pathname === "/dashboard/calendar"
                ? `${
                    isDarkTheme
                      ? "bg-purple-700"
                      : "bg-indigo-200 sm:bg-indigo-100"
          ...
          <div className="mb-3 flex items-center justify-between">
            <h2
              className={`text-lg font-semibold ${
                isDarkTheme
                  ? "text-purple-200"
                  : "text-gray-900 sm:text-gray-800"
              }`}
            >
              {t("myCategories")}
            </h2>
                      ...
                      {editingId === category.id ? (
                        <input
                          ...
                          className={`ml-2 flex-1 rounded-lg ${
                            ...
                            isDarkTheme
                              ...
                              : "focus:ring-indigo-400 sm:focus:ring-indigo-300"
                          }`}
                          autoFocus
                        ...
                        <span
                          ...
                          className={`ml-2 cursor-pointer ${
                            isDarkTheme
                              ? "text-gray-100"
                              : "text-gray-900 sm:text-gray-700"
                          } font-medium`}
                        >
                          {category.name}
                        </span>
